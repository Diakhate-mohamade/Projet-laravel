...
<head>
    ...
    <style>
        ...
        .contact p {
            margin-bottom: 20px; /* Espacement entre les paragraphes du footer */
        }

        .contact a {
            color: #fff; /* Couleur des liens dans le footer */
        }

        .contact a:hover {
            color: #ccc; /* Couleur des liens au survol dans le footer */
        }

        /* Styles du logo */
        .footer-logo a {
            color: #fff; /* Couleur du texte du logo */
            font-size: 24px; /* Taille de la police du logo */
            font-weight: bold; /* Gras pour le logo */
        }

        /* Styles de la section newsletter */
        .footer-newsletter {
            margin-top: 20px; /* Espacement du haut de la section newsletter */
        }
        ...
        .foot-email-box {
            flex: 1; /* Fait prendre tout l'espace disponible à la boîte email */
            margin-right: 10px; /* Marge à droite pour l'espacement */
        }

        .foot-email-subscribe {
            flex: 0 0 auto; /* Ne pas étirer cette partie, elle reste à la même largeur */
        }
    </style>
			...
			<div class="container">
						...
						<div class="col-md-offset-1 col-md-3 col-sm-6">
							<div class="single-footer-widget">
								...
								<div class="footer-newsletter">
									<p>
										Abonnez-vous pour recevoir les dernières nouvelles et informations
									</p>
								</div>
				...
				<div class="footer-copyright">
					<div class="row">
						<div class="col-sm-6">
							<p>
								&copy; copyright.designed and developed by Mohameth&Khalil</a>.
							</p><!--/p-->
						</div>
						<div class="col-sm-6">
