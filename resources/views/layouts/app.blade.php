@if (Auth::check() && Auth::user()->usertype != '0')
    ...
    <head>
        ...
        <!--<link rel="stylesheet" href="{{ asset('css/vos-styles-personnalises.css') }}">-->
            ...
            <div class="flex justify-between">
                ...
                <div class="flex items-center">
                    ...
                    <button data-dropdown
                        ...
                        <span class="ml-4 text-sm hidden md:inline-block">AutoAventure</span>
                ...
                <div class="sidebar text-center bg-gray-900">
                    ...
                    <a href="{{ route('admin/chauffeurs') }}">
                        <div
                            ...
                            <span class="text-[15px] ml-4 text-gray-200 font-bold">Chauffeur</span>
                        </div>
                    </a>
                    <a href="{{ route('admin/vehicules') }}">
                        <div
                            class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
                            <i class="bi bi-bookmark-fill"></i>
                            <span class="text-[15px] ml-4 text-gray-200 font-bold">Vehicule</span>
                        </div>
                    </a>
                    <a href="{{ route('admin/locations') }}">
                        <div
                            class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
                            <i class="bi bi-bookmark-fill"></i>
                            <span class="text-[15px] ml-4 text-gray-200 font-bold">Reservation</span>
                        </div>
                    </a>
